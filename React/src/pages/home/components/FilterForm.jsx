...
const FilterForm = () => {
  ...
  return (
    <section className="bg-white -mt-44 sm:-mt-72 md:-mt-16 lg:-mt-32 xl:-mt-44 shadow-[0_1px_18px_8px_rgba(0,0,0,0.1)] rounded-md rounded-tl-none p-4 w-[90%] max-w-6xl mx-auto z-10 relative">
